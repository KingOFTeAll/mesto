export class FormValidator {
  ...
  _toggleButtonState() {
    if (this._hasInvalidInput()) {
      this._buttonElement.classList.add(this._formSetting.disabledSubmitButton);
      this._buttonElement.disabled = true;
    } else {
      this._buttonElement.classList.remove(this._formSetting.disabledSubmitButton);
  ...
  _hideInputError(inputElement) {
    ...
    inputElement.classList.remove(this._formSetting.inputErrorSelector);
  ...
  _showInputError(inputElement, errorMessage) {
    const errorElement = this._form.querySelector(`.${inputElement.id}-error`);
    inputElement.classList.add(this._formSetting.inputErrorSelector);
